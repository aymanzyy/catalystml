...
mpiexec -n 1 --ppn 1 --depth=1 --cpu-bind depth ./set_affinity_gpu_polaris.sh ./test_build/lbm-proxy-app ./data/proxy_input_file.txt ./bridge/autoencoder_offline_train_online_infer.py 
