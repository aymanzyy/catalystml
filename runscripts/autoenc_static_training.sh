...
mpiexec -n 4 --ppn 4 --depth=1 --cpu-bind depth ./set_affinity_gpu_polaris.sh ./test_build/lbm-proxy-app proxy_input_file.txt ./bridge/autoencoder_train_last_call.py