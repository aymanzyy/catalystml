...
mpiexec -n 4 --ppn 4 --depth=1 --cpu-bind depth ./set_affinity_gpu_polaris.sh ./test_build/lbm-proxy-app paper_test_training.txt ./catalyst_scripts/auto_encoder_train_last_call.py